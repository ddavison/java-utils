...
public class HttpUtil {
     ...
     * @throws IOException
     */
    public static String put(String url, HashMap<String, String> params) throws IOException {
        String body = null;
     ...
     * @throws IOException
     */
    public static String delete(String url, HashMap<String, String> params) throws IOException {
        String body = null;
     ...
     * @throws IOException
     */
    public static String request(String method, String url, String body, HashMap<String, String> params) throws IOException {
